...
public class FileSystemResourceConnection implements ResourceController {
    ...
    public String getData(String url) throws IOException {
        ...
        } else if (url.equals("http://api.deezer.com/track/84325325")) {
            return readFileToString("singleMethodService/lv4ExampleTrack.json");

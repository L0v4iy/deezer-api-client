...
public class DeezerRestTemplate {
    ...
    private ResourceController resourceConnection;
    private DeezerApiWrapper apiWrapper;

    public DeezerRestTemplate(ResourceController resourceConnection) {
        this.resourceConnection = resourceConnection;
        this.apiWrapper = new DeezerApiWrapper(resourceConnection);
    }

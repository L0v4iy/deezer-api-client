...
import com.L0v4iy.deezer.service.DeezerRestTemplate;
...
public class DeezerClient {
    ...
    public DeezerClient(ResourceController resourceController) {
        baseService = new DeezerRestTemplate(resourceController);
    }
